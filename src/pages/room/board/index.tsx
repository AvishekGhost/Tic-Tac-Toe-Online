...
import { Block, Container, Row, IsMarked } from "./styles";
		...
		<Container marking={isMarking}>
			<Row>
				<Block onClick={() => handleClick(0)}>
					{board[0] ? <IsMarked>{board[0]}</IsMarked> : board[0]}
				</Block>
				<Block onClick={() => handleClick(1)}>
					{board[1] ? <IsMarked>{board[1]}</IsMarked> : board[1]}
				</Block>
				<Block onClick={() => handleClick(2)}>
					{board[2] ? <IsMarked>{board[2]}</IsMarked> : board[2]}
				</Block>
			</Row>
			<Row>
				<Block onClick={() => handleClick(3)}>
					{board[3] ? <IsMarked>{board[3]}</IsMarked> : board[3]}
				</Block>
				<Block onClick={() => handleClick(4)}>
					{board[4] ? <IsMarked>{board[4]}</IsMarked> : board[4]}
				</Block>
				<Block onClick={() => handleClick(5)}>
					{board[5] ? <IsMarked>{board[5]}</IsMarked> : board[5]}
				</Block>
			</Row>
			<Row>
				<Block onClick={() => handleClick(6)}>
					{board[6] ? <IsMarked>{board[6]}</IsMarked> : board[6]}
				</Block>
				<Block onClick={() => handleClick(7)}>
					{board[7] ? <IsMarked>{board[7]}</IsMarked> : board[7]}
				</Block>
				<Block onClick={() => handleClick(8)}>
					{board[8] ? <IsMarked>{board[8]}</IsMarked> : board[8]}
				</Block>
			</Row>
		</Container>
	);
